...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-ep-1133-erd-s-problem-1133-5cef4ffa-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/EP-1133"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-ep-1133-erd-s-problem-1133-5cef4ffa-v1",
      "problem_contract_sha256": "79bb84cca0e52bc4fb78ba258a7e35968a83b7be058163772321c52fad9316b2",
      "problem_id": "problem:um-ep-1133-erd-s-problem-1133-5cef4ffa",
      "route_id": "route:um-ep-1133-erd-s-problem-1133-5cef4ffa-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-ep-1133-erd-s-problem-1133-5cef4ffa-source-fidelity-01",
      "graph_id": "graph:um-ep-1133-erd-s-problem-1133-5cef4ffa-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-ep-1133-erd-s-problem-1133-5cef4ffa-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-ep-1133-erd-s-problem-1133-5cef4ffa-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Let $C>0$. There exists $\\epsilon>0$ such that if $n$ is sufficiently large the following holds. For any $x_1,\\ldots,x_n\\in [-1,1]$ there exist $y_1,\\ldots,y_n\\in [-1,1]$ such that, if $P$ is a polynomial of degree $m<(1+\\epsilon)n$ with $P(x_i)=y_i$ for at least $(1-\\epsilon)n$ many $1\\leq i\\leq n$, then $ \\max_{x\\in [-1,1]}\\lvert P(x)\\rvert >C. $"
          },
          "statement_sha256": "6eb8e103d1969b9612e2e3d99686ff2fcc257bb1cf3790e4829e577711045ab9"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-ep-1133-erd-s-problem-1133-5cef4ffa-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-ep-1133-erd-s-problem-1133-5cef4ffa-root",
      "route_id": "route:um-ep-1133-erd-s-problem-1133-5cef4ffa-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-ep-1133-21b21b9fbb1e",
        "url": "https://www.unsolvedmath.com/problems/EP-1133"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
